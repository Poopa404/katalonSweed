...
WebUI.click(findTestObject('Page_SWEED/button_AddToCart2'))

WebUI.click(findTestObject('Object Repository/Page_SWEED/button_Cart'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_SWEED/h3_FoodName'), food2)

WebUI.verifyElementText(findTestObject('Page_SWEED/span_Price2'), price2)
