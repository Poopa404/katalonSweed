...
WebUI.click(findTestObject('Object Repository/Page_SWEED/button_AddtoCart1'))

WebUI.click(findTestObject('Object Repository/Page_SWEED/button_Cart'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_SWEED/h3_FoodName'), food1)

WebUI.verifyElementText(findTestObject('Object Repository/Page_SWEED/span_Price1'), price1)
