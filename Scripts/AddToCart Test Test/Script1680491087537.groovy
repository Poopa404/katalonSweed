...
WebUI.click(findTestObject('Page_SWEED/button_AddToCart Test', [('id') : id]))

WebUI.click(findTestObject('Object Repository/Page_SWEED/button_Cart'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_SWEED/h3_FoodName'), food)

WebUI.verifyElementText(findTestObject('Page_SWEED/span_Price Test', [('foodName') : food]), price)
